...
from tunamelt.data import find_files
...
label_out_path = Path(
    f"{REPO_PATH}/data/PNNL-TUNAMELT/labels/cvat-video-1.1/batched_test"
)
video_out_path = Path(f"{REPO_PATH}/data/PNNL-TUNAMELT/mp4/batched_test")
