import cv2
import numpy as np
from turbx.utils import generate_sinusoid, generate_sinusoid_tile
...
def test_generate_sinusoid():
    ...
    waveform_1 = generate_sinusoid(freq=freq_1, fps=fps, shape=shape, length=length)
    waveform_2 = generate_sinusoid(freq=freq_2, fps=fps, shape=shape, length=length)
